...
WebUI.click(findTestObject('Object Repository/Page_Moodle Administration Users Accounts Add a new user/a_Click to enter text'))
...
WebUI.click(findTestObject('Object Repository/Page_Moodle Administration Users Accounts A_0fbd97/div_This username already exists, choose another'))
