...
WebUI.setText(findTestObject('Object Repository/Page_Moodle Add a new course/input_Course full name_fullname'), 'Thiết kế phần mềm')

WebUI.setText(findTestObject('Object Repository/Page_Moodle Add a new course/input_Course short name_shortname'), 'CSC13010')
...
WebUI.click(findTestObject('Object Repository/Page_Moodle Add a new course/div_Short name is already used for another _588d57'))
