...
WebUI.setText(findTestObject('Object Repository/Page_Announcements/input_Subject_subject'), 'Testing')

WebUI.setText(findTestObject('Object Repository/Page_Announcements/div_Testing'), '<p dir="ltr" style="text-align: left;">Testing</p>')
