...
WebUI.setText(findTestObject('Object Repository/Page_Moodle Add new category/input_Category name_name'), 'Công nghệ thông tin')

WebUI.setText(findTestObject('Object Repository/Page_Moodle Add new category/input_Category ID number_idnumber'), '1')

WebUI.click(findTestObject('Object Repository/Page_Moodle Add new category/input_Description_submitbutton'))

WebUI.click(findTestObject('Object Repository/Page_Course and category management/h2_Course and category management'))
