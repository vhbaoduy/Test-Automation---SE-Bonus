...
WebUI.click(findTestObject('Object Repository/Page_Dashboard/span_Trong Le'))
...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Change password/input_New password_newpassword1'), 'cvW8qx4B2o3F4VwP/kNsqA==')
