...
WebUI.setText(findTestObject('Object Repository/Page_New Forum/input_Subject_subject'), 'Free Discussion')

WebUI.setText(findTestObject('Object Repository/Page_New Forum/div_Lets talk together'), '<p dir="ltr" style="text-align: left;">Let\'s talk together.</p>')

WebUI.click(findTestObject('Object Repository/Page_New Forum/input_Message_submitbutton'))

WebUI.click(findTestObject('Object Repository/Page_New Forum/a_Free Discussion'))
