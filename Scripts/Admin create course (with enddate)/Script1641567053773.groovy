...
WebUI.setText(findTestObject('Object Repository/Page_Moodle Add a new course/input_Course full name_fullname'), 'Phân tích và quản lý yêu cầu phần mềm')

WebUI.setText(findTestObject('Object Repository/Page_Moodle Add a new course/input_Course short name_shortname'), 'CSC13005')
...
WebUI.click(findTestObject('Object Repository/Page_CSC13005 Participants/h2_Participants'))
